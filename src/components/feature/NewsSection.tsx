...
export default function NewsSection() {
  ...
  return (
    <section className="pt-8 sm:pt-12 md:pt-16 pb-16 sm:pb-20 md:pb-24 bg-gradient-to-br from-gray-50 via-white to-[#37B7C4]/5 relative overflow-hidden" id="news">
      {/* 背景装飾 */}
