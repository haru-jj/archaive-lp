    ...
    >
      <div className='pointer-events-none absolute inset-0 z-0'>
        ...
        <div className='absolute inset-x-[-12%] top-[18%] h-[32rem] overflow-hidden opacity-45 [mask-image:linear-gradient(180deg,transparent_0%,black_18%,black_72%,transparent_100%)] sm:top-[14%] sm:h-[38rem] lg:hidden'>
          <div className='absolute top-[8.5rem] left-[-4%] w-[15rem] -rotate-12 overflow-hidden rounded-[1.15rem] border-[3px] border-white/75 bg-white shadow-[0_24px_54px_rgba(0,26,71,0.18)] blur-[1.5px] sm:left-[8%] sm:w-[19rem]'>
          ...
          <div className='absolute top-24 right-[-6%] w-[16rem] rotate-10 overflow-hidden rounded-[1.15rem] border-[3px] border-white/75 bg-white shadow-[0_24px_54px_rgba(0,26,71,0.18)] blur-[1.5px] sm:right-[8%] sm:w-[20rem]'>
            <div className='relative aspect-[16/10]'>
              <Image
                src='/lp-v2/page_2.png'
                alt=''
      ...
      <div className='pointer-events-none absolute inset-x-0 -bottom-px z-10 text-[var(--lp-primary-strong)] sm:-bottom-0'>
        <WaveOverlay height={176} baselineRatio={0.55} />
      </div>

      <div className='relative mx-auto flex min-h-[84svh] max-w-[1520px] flex-col justify-center px-5 pt-20 pb-24 sm:px-10 sm:pt-24 sm:pb-28 lg:h-[86svh] lg:min-h-0 lg:px-14 lg:pt-20 lg:pb-20 xl:px-18'>
        <div className='grid items-start gap-10 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] lg:items-center'>
          <div className='relative z-10 pt-4 text-white lg:pt-0'>
            <h2 className='text-lp-text mt-4 text-[2.125rem] leading-[1.2] font-bold drop-shadow-[0_2px_0_rgba(255,255,255,0.28)] sm:mt-6 sm:text-[3rem]'>
              製造業のノウハウが
              <br />
            ...
            <div className='mt-8 sm:mt-9'>
              <RippleLink
                href='#contact'
                className='group relative inline-flex min-h-[6.2rem] w-full max-w-[34rem] items-center overflow-hidden rounded-[0.7rem] bg-[var(--lp-text)] px-4 py-4 text-white shadow-[0_22px_42px_rgba(0,26,71,0.32)] transition-transform duration-300 hover:-translate-y-0.5 sm:min-h-[7.6rem] sm:max-w-[34rem] sm:px-6 sm:py-5'
                bgClassName='bg-[color-mix(in_srgb,var(--lp-text)_70%,var(--lp-primary)_30%)]'
                contentClassName='w-full justify-between gap-3 text-inherit sm:gap-5'
              >
                <span className='relative aspect-[16/9] w-[7rem] shrink-0 sm:w-[9rem]'>
                  <span className='absolute inset-0 origin-center overflow-hidden rounded-[0.45rem] bg-white/12 ring-1 ring-white/15 transition-transform duration-500 ease-out group-hover:-translate-x-[46%] group-hover:-rotate-[16deg]'>
                    <Image
                      src='/lp-v2/hero_p2.png'
                      alt=''
                      fill
                  ...
                  <span className='absolute inset-0 overflow-hidden rounded-[0.45rem] bg-white/12 shadow-[0_8px_18px_rgba(0,26,71,0.32)] ring-1 ring-white/15 transition-transform duration-500 ease-out'>
                    <Image
                      src='/lp-v2/hero_p1.png'
                      alt=''
                      fill
                      sizes='(min-width: 640px) 140px, 110px'
                      className='object-cover object-left-top'
                ...
                <span className='min-w-0 flex-1 text-center font-bold text-white'>
                  <span className='block text-[clamp(1.05rem,3vw,1.25rem)] leading-[1.2] sm:text-[clamp(1.25rem,1.85vw,1.45rem)]'>
                    「図面管理のその先」
                  </span>
                  <span className='block text-[clamp(0.85rem,2.4vw,1rem)] leading-[1.34] sm:text-[clamp(0.95rem,1.4vw,1.1rem)]'>
                    がわかる資料を無料で
                  </span>
                </span>
                <ArrowRight
                  className='h-5 w-5 shrink-0 text-white sm:h-7 sm:w-7'
                  strokeWidth={2.4}
                />
              </RippleLink>
            </div>

            <p className='text-lp-text mt-7 max-w-[42rem] text-[1rem] leading-[1.85] font-normal drop-shadow-[0_1px_0_rgba(255,255,255,0.22)] sm:mt-8 sm:text-[clamp(1.05rem,1.2vw,1.125rem)]'>
              図面と図面に紐づくものづくりの情報を製品単位で蓄積する
              <br />
              次世代AIデータ基盤ARCHAIVE。
            </p>
          </div>
            ...
            >
              <div className='grid grid-cols-3 gap-x-7 gap-y-9'>
                {GHOST_PAGE_IMAGES.map((src, i) => (
                  ...
                  >
                    <div className='overflow-hidden rounded-[1.8rem] border-[3px] border-white bg-white shadow-[0_18px_36px_rgba(15,23,42,0.14)]'>
              ...
              <div className='grid grid-cols-2 gap-x-8 gap-y-10 xl:gap-x-9 xl:gap-y-11'>
                {PAGE_IMAGES.map((page) => (
                  <div key={page.src} className={page.slotClassName}>
                    <div className='overflow-hidden rounded-[1.8rem] border-[3px] border-white bg-white shadow-[0_28px_50px_rgba(15,23,42,0.18)]'>
