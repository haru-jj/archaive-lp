      ...
      <main className="pt-20">
        ...
        <div className="bg-[#f4f4f4] py-20 flex justify-center min-h-screen">
          <div className="w-[70%] max-w-none mx-auto">
            ...
            <h2 className="text-2xl mt-6 mb-12 font-bold">製造業のDXを加速するAIプラットフォーム「ARCHAIVE 2.1」を2025年10月1日より提供開始</h2>
            ...
            <div className="news-article">
              ...
              <h3 className="text-xl font-bold mt-8 mb-4">開発の背景：製造業が抱える「情報のサイロ化」という課題</h3>
              <p className="text-base leading-6 mb-6">
              ...
              <h3 className="text-xl font-bold mt-8 mb-4">製造業AIプラットフォーム「ARCHAIVE 2.1」の主な特長</h3>
              <p className="text-base leading-6 mb-6">
                「ARCHAIVE 2.1」は、以下の3つの主要なサービスで構成され、製造業の多様なニーズに柔軟に対応します。
              </p>

              <div className="mb-6">
                <h4 className="text-lg font-bold mb-3">1. ARCHAIVE-CORE： AI図面解析・見積クラウド</h4>
              ...
              <div className="mb-6">
                <h4 className="text-lg font-bold mb-3">2. ARCHAIVE-CRM（β版）： AI顧客管理クラウド</h4>
                <p className="text-base leading-6 mb-4">
              ...
              <div className="mb-6">
                <h4 className="text-lg font-bold mb-3">3. ARCHAIVE+： カスタムAIソリューションサービス</h4>
                <p className="text-base leading-6 mb-4">
                  お客様独自の業務フローや特別な課題に対し、専門のチームがヒアリングを行い、最適なカスタムAIソリューションを開発・提供します。外観検査AIの構築や、需要予測AIの導入など、企業の競争力強化に直結するDXをオーダーメイドで支援します。
                </p>
              </div>

              <h3 className="text-xl font-bold mt-8 mb-4">今後の展望：All in Oneの製造業AIクラウドを目指して</h3>
              <p className="text-base leading-6 mb-6">
