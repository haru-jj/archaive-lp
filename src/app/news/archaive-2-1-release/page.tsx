          ...
          <div className="w-[70%] max-w-none mx-auto">
            ...
            <div className="bg-white p-8 sm:p-12 shadow-lg rounded-lg h-fit space-y-10">
              ...
              <div className="space-y-6 text-base leading-7 text-gray-700">
                ...
                <p>
                  「ARCHAIVE 2.1」は、従来のAI図面管理システム「ARCHAIVE 1.0」を大幅にアップデートし、新たにAI顧客管理クラウド（CRM）機能や、企业ごとの課題に対応するカスタムAIソリューションサービスを統合。これにより、図面データの活用から見積作成、案件管理までをシームレスに連携させ、製造業における多様なニーズに応えるプラットフォームへと進化しました。
                </p>
                ...
                <section className="space-y-4">
                  <h2 className="text-xl font-bold text-gray-900 border-l-4 border-[#37B7C4] pl-3">
                    製造業AIプラットフォーム「ARCHAIVE 2.1」の主な特長
                  </h2>
                  <p>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <h3 className="text-lg font-bold text-gray-800">1. ARCHAIVE-CORE： AI図面解析・見積クラウド</h3>
                      <p>
                    ...
                    <div className="space-y-2">
                      <h3 className="text-lg font-bold text-gray-800">2. ARCHAIVE-CRM（β版）： AI顧客管理クラウド</h3>
                      <p>
                        図面データと顧客情報、案件情報を紐づけて一元管理できる、製造業特化型のCRM機能です。どの顧客からいつ、どのような図面の引き合いがあったかを可視化し、営業活動の効率化と顧客対応の品質向上を支援します。
                      </p>
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-lg font-bold text-gray-800">3. ARCHAIVE+： カスタムAIソリューションサービス</h3>
                      <p>
                ...
                <section className="space-y-4">
                  <h2 className="text-xl font-bold text-gray-900 border-l-4 border-[#37B7C4] pl-3">
                    今後の展望：All in Oneの製造業AIクラウドを目指して
                  </h2>
                  <p>
