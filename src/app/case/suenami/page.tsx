...
const caseData = {
  ...
  image: 'https://archaive.net/images/yokoyama_1.webp',
};
...
const reviewData = {
  ...
  company: 'スエナミ工業株式会社',
  reviewBody:
    '100枚を超える図面見積をAIが支援し、過去履歴と照合しながら対話的に概算を算出できる点を高く評価。AIエージェント機能でCSV出力まで完結し、独自ロジックを学習させた見積自動化に期待が寄せられています。',
};
        ...
        <div className={styles['interview-content-wrapper']}>
          <div className={styles['interview-content']}>
            ...
            <div className="mb-12">
              ...
              <p>(横山)： まずは、複雑な見積もり業務をAIがサポートしてくれることです。特に、図面をアップロードするだけで、過去の履歴やトラブル情報と紐付けてAIが対話しながら見積もりを算出する「AIエージェント」のような機能に期待しています。多数の図面を一括で処理し、概算見積もりをCSVで出力できる機能は、私たちの業務を効率化してくれています。<br />
